...
import { orderModes, restaurantInfo, type OrderModeId } from "@/data/menu";
import { formatCurrency, getCartCount, getCartSubtotal, getOrderModeById, serializeSelections, type CartItem, type CustomerDetails } from "@/lib/menu";
