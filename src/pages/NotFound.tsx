      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-8 grid overflow-hidden border border-black/12 lg:grid-cols-[0.42fr_0.58fr]">
          <article className="bg-black px-7 py-8 text-white sm:px-10 sm:py-10">
            <p className="editorial-kicker text-[#cfa066]">404</p>
            ...
            <p className="mt-5 max-w-md text-lg leading-8 text-white/72">
              La ruta <span className="text-white">{location.pathname}</span> no corresponde a ninguna seccion activa del sitio.
            </p>

            <div className="mt-8 flex flex-wrap gap-3">
              <Button asChild className="h-12 border border-[#cfa066] bg-[#cfa066] px-6 text-[11px] font-semibold uppercase tracking-[0.24em] text-black hover:bg-[#cfa066]/90">
                <Link to="/">Volver al inicio</Link>
              </Button>
              <Button
                asChild
                variant="outline"
                className="h-12 border border-white/18 bg-transparent px-6 text-[11px] font-semibold uppercase tracking-[0.24em] text-white hover:bg-white/8"
              >
          ...
          <article className="bg-[#cfa066] px-7 py-8 text-black sm:px-10 sm:py-10">
